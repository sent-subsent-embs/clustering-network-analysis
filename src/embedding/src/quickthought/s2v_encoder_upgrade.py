...
import s2v_model_upgrade as s2v_model
...
class s2v_encoder(object):
  ...
  def encode(self,
             ...
             batch_size=128,
             use_eos=False):
    """Encodes a sequence of sentences as skipthought vectors.

    Args:
      sess: TensorFlow Session.
      data: A list of input strings.
      use_norm: Whether to normalize skipthought vectors to unit L2 norm.
    ...
    Returns:
      thought_vectors: A list of numpy arrays corresponding to the skipthought
